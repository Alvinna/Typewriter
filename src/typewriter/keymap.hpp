...
class KeycodeTranslation {
    int _is_leftmeta_down = 0;
    int _is_rightmeta_down = 0;
    int _is_leftctrl_down = 0;
    int _is_leftshift_down = 0;
    int _is_rightshift_down = 0;
    int _is_leftalt_down = 0;
    int _is_capslock_down = 0;
    int _is_rightctrl_down = 0;
    int _is_rightalt_down = 0;
    int scrolllock_state = 0;
    int numlock_state = 0;
